...
function Product(props) {
  return (
    ...
    <div className="w-full gap-4 grid  sm:grid-cols-2 px-6 py-2">
      ...
      <button className="bg-black text-white rounded-lg  p-2 w-fit hover:bg-white hover:text-black" onClick={()=>deleteItem(props.item._id)}>Delete</button>
      <button className="bg-black text-white rounded-lg  p-2 w-fit hover:bg-white hover:text-black">Edit</button>
    </div>
